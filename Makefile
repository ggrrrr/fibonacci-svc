...
docker_run_dev_redis: docker_run_dev_env
	docker-compose up -d fi_redis

docker_run_dev_pg: docker_run_dev_env
	docker-compose up -d fi_pg

docker_run_dev_ram: docker_run_dev_env
	docker-compose up -d fi_ram
